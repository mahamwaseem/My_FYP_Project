...
const PATHS = {
  ...
  rows: <><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="15" x2="21" y2="15"/></>,
  ...
  empty: <><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></>,
};

export default function Icon({ name, size = 18, stroke = 1.8, style }) {
  return (
